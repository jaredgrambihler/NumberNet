...
class Layer:
    #Layer class to define input, weights, activation function

    def __init__(self, inputSize, outputSize, bias = False, activationFunction = ""):
        #code from old create layer method
        self.input = []
        self.weigths = []
        self.bias = []
...
class Weights:
    ...
    def __init__(self, inputSize, outputSize):
        ##REPLACE X AND Y WITH INPUTSIZE AND OUTPUTSIZE
        """
